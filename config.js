/**
 * Global Configuration for Hunter Bot
 */

module.exports = {
    // Bot Owner Configuration
    ownerNumber: ['254790759013'], // Add your number without + or spaces (e.g., 254790759013)
    ownerName: ['HUNTER254'], // Owner names corresponding to ownerNumber array
    
    // Bot Configuration
    botName: '╔═══❖•ೋ° HUNTER254 BOT °ೋ•❖═══╗',
    prefix: '>',
    sessionName: 'session',
